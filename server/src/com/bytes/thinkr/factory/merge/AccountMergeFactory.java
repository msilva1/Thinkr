...
public class AccountMergeFactory extends MergeFactory<Account> {
    ...
    private static final Logger LOGGER = Logger.getLogger(AccountMergeFactory.class.getName());
    ...
    public static MergeMap getDataMap(Account account) {
        ...
        if (client == null) {
            if (LOGGER.isLoggable(Level.FINE)) {
                LOGGER.log(Level.FINE, "Unable to merge, client data not found.");
            }
            return dataMap;
        }
        ...
        if (name == null) {
            if (LOGGER.isLoggable(Level.FINER)) {
                LOGGER.log(Level.FINER, "Client name has no data.");
            }
            return dataMap;
        }
    ...
    public static int setDataMap(MergeMap<Field, Object> dataMap, Account account) {
        ...
        if (name == null) {
            ...
            if (LOGGER.isLoggable(Level.FINE)) {
                LOGGER.log(Level.FINE, "Name data is missing in database, creating new instance.");
            }
        ...
        if (LOGGER.isLoggable(Level.FINE)) {
            LOGGER.log(Level.FINE, "Updated " + count + " entries");
        }
        return count;
    }
}
